...
export default function SpotifyWidget() {
  ...
  return (
    <div className="w-full bg-black/30 backdrop-blur-sm rounded-xl p-3 border-l-4 border-[#1DB954]">
      <div className="flex items-center gap-1 mb-2">
        ...
        <span className="text-[#1DB954] text-xs font-bold tracking-wider uppercase">Listening on Spotify</span>
      </div>
      {loading ? (
        ...
        <a href={track.songUrl || '#'} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
          {track.albumArt && (
        ...
        <p className="text-white/50 text-sm">Not currently playing</p>
      )}
    </div>
  )
}
