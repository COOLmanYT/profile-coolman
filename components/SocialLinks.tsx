...
export default function SocialLinks() {
  const links = [
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@COOLmanGamer',
      icon: (
    ...
    {
      name: 'Spotify',
      href: 'https://open.spotify.com/user/31px5awkcyikvgrfiiqkxem6oxni?si=179034a009484594',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
      name: 'Discord',
      href: 'https://discord.gg/SzHksR3QFj',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
      name: 'Roblox',
      href: 'https://www.roblox.com/users/2873599962/',
      icon: (
        <Image
